...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, TieredMenuModule],
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <p-tieredMenu appendTo="body" #menu [model]="profileItems" [popup]="true" [autoZIndex]="true"></p-tieredMenu>
                    <button #btn (click)="menu.toggle($event)" class="p-link layout-topbar-action">
